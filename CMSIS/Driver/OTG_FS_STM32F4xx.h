...
#define OTG_FS_USBD_DRIVER_INITIALIZED (1 << 0)
#define OTG_FS_USBD_DRIVER_POWERED     (1 << 1)
#define OTG_FS_USBD_DRIVER_CONNECTED   (1 << 2)
#define OTG_FS_USBH_DRIVER_INITIALIZED (1 << 4)
#define OTG_FS_USBH_DRIVER_POWERED     (1 << 5)
